...
public class RegisterPage extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //check username and password according to the format
        registerButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String email = editTextEmail.getText().toString().trim();
                String pass = editTextPassword.getText().toString().trim();
                String passConfirm = editTextConfirmPassword.getText().toString().trim();
                ...
                if (passConfirm.equals(pass) == false) {
                    editTextConfirmPassword.setError("Confirm Password must match with password");
                    editTextConfirmPassword.requestFocus();
                    return;
                }
                                    ...
                                    FirebaseDatabase.getInstance().getReference("Users")
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()){
                                                ...
                                                Toast.makeText(RegisterPage.this, "Register failed, try again!", Toast.LENGTH_LONG).show();
                                                progressBar.setVisibility(View.GONE);
                                            }
                                        }
                                    });
